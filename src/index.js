...
if (process.argv[1] && new URL(import.meta.url).pathname === process.argv[1]) {
  ...
  if (app.telegram) app.telegram.launch().then(() => app.forge.logger.info('NexusForgeManagerBot started')).catch(error => app.forge.logger.error(error, 'Telegram bot failed to start'));
}
